...
{
    public class JavaClass_IdGenerator : AbstractFileModel
    {
        JavaCodeGenerator _generater = new JavaCodeGenerator();
        string className = "IdGenerator";
        Data _data = null;
        public JavaClass_IdGenerator(Data data)
        {
            _data = data;
